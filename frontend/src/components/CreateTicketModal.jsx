...
const CreateTicketModal = ({ onClose, onTicketCreated, preselectedProject = null }) => {
    ...
    // Подгружаем этапы, если выбран проект
    useEffect(() => {
        if (ticketData.project) {
            getStages(ticketData.project).then(res => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!dataToSubmit.stage) delete dataToSubmit.stage; // Если этап не выбран
