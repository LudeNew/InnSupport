...
class ProjectSerializer(serializers.ModelSerializer):
    ...
    total_spent_hours = serializers.SerializerMethodField() # Новое поле: Все время
    active_stages_count = serializers.SerializerMethodField() # Новое поле: Активные этапы
